...
const optionsEl = document.getElementById('chat-options') as HTMLElement;
...
function setOptions(opts: string[], onClick: (opt: string) => void) {
    optionsEl.innerHTML = '';
    opts.forEach(opt => {
...
document.getElementById('chat-send')?.addEventListener('click', sendFreeText);
